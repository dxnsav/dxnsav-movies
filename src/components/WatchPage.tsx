...
const WatchPage = () => {
	...
	return (
		<div className="font-player">
			...
			{
				showDescription ? (<>
					<Button variant="ghost" className='w-12 h-12 p-0 rounded-full absolute top-16' onClick={() => handleQuit()}>
						<Link to='/' >
							<ArrowLeftIcon className="w-5 h-5" />
						</Link>
					</Button>
					<Button variant="ghost" className='w-12 h-12 p-0 rounded-full absolute top-16 right-16' onClick={() => handleClickRewindForward()}>
